...
<ul class='list-group list-group-flush'>
	<li class='list-group-item'><a href="<?php echo e(url('/adminpanel/section/class/'.$class->id)); ?>" style="font-weight:bold;font-size:25px;"><?php echo e($class->classname); ?>(<?php echo e($class->number); ?>)</a></li>
</ul>	

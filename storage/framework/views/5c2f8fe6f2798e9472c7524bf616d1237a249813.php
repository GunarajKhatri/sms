        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Class</h3><br>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo e(route('class.store')); ?>">
              <?php echo e(csrf_field()); ?>

              <div class="box-body">
              	</div><div class="form-group">
                  <label for="exampleInputclassname">Class Name</label>
                  <input type="text" class="form-control"name="classname" id="exampleInputemail" placeholder="Enter classname">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Numeric value</label>
                  <input type="number" class="form-control"name="number"placeholder="In Number">

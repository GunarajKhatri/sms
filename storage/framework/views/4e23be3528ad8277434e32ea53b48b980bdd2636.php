...
<h2 class="blog-post-title"><?php echo e($posts->head); ?></h2>

<p class="blog-post-meta"> <?php echo e($posts->created_at); ?> <a href="#" style="text-decoration: none;" class="text-dark font-weight-bold">By Admin</a></p><br>
<p><?php echo e($posts->main); ?></p>

<?php if(auth('admin')->check() && auth('admin')->user()->hasRole('writer|Admin')): ?>
<a href="/blog/public/post/<?php echo e($posts->id); ?>"class='text-default'style="text-decoration: none;">create</a>
<?php endif; ?>
<?php if(auth('admin')->check() && auth('admin')->user()->hasRole('editor|Admin')): ?>
<a href="/blog/public/post/<?php echo e($posts->id); ?>"class='text-default'style="text-decoration: none;">Edit</a>
<?php endif; ?>
...
<br>
<form class="post" style="display: none;" method="post" action=<?php echo e(url("/post")); ?>>
	<?php echo e(csrf_field()); ?>
...
<form class="comment" method="post" action=<?php echo e(url("/post/comment")); ?>>
	<?php echo e(csrf_field()); ?>
...
<h4 class='text-default'><?php echo e($users->name); ?></h4>
<p class='ml-5'><?php echo e($comments->feedback); ?></p>

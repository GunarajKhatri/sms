            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo e(route('admin-edit',$datas->id)); ?>"><i class="fa fa-edit"></i></a>
                  <a href="<?php echo e(route('admin-delete',$datas->id)); ?>" style="margin-left:25px; "><i class="fa fa-trash"></i></a></td>
